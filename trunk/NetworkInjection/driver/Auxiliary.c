...
*/
{
    ...
    case FWPS_LAYER_INBOUND_IPPACKET_V4:
        *flagsIndex = FWPS_FIELD_INBOUND_IPPACKET_V4_FLAGS;
        break;
    case FWPS_LAYER_INBOUND_IPPACKET_V6:
        *flagsIndex = FWPS_FIELD_INBOUND_IPPACKET_V6_FLAGS;
        break;

    case FWPS_LAYER_OUTBOUND_IPPACKET_V4:
        *flagsIndex = FWPS_FIELD_OUTBOUND_IPPACKET_V4_FLAGS;
        break;
    case FWPS_LAYER_OUTBOUND_IPPACKET_V6:
        *flagsIndex = FWPS_FIELD_OUTBOUND_IPPACKET_V6_FLAGS;
        break;
                                         ...
                                         _Out_ UINT * subInterfaceIndexIndex)
{
    ...
    *subInterfaceIndexIndex = 0;
    ...
    case FWPS_LAYER_INBOUND_IPPACKET_V4:
        *interfaceIndexIndex = FWPS_FIELD_INBOUND_IPPACKET_V4_INTERFACE_INDEX;
        *subInterfaceIndexIndex = FWPS_FIELD_INBOUND_IPPACKET_V4_SUB_INTERFACE_INDEX;
        break;
    case FWPS_LAYER_INBOUND_IPPACKET_V6:
        *interfaceIndexIndex = FWPS_FIELD_INBOUND_IPPACKET_V6_INTERFACE_INDEX;
        *subInterfaceIndexIndex = FWPS_FIELD_INBOUND_IPPACKET_V6_SUB_INTERFACE_INDEX;
        break;
